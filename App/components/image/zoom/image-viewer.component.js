...
var react_native_image_pan_zoom_1 = require("./image-zoom.component");//require("react-native-image-pan-zoom");
...
var ImageViewer = /** @class */ (function (_super) {
    ...
    function ImageViewer() {
        ...
        _this.saveToLocal = function () {
            if (!_this.props.onSave) {
                react_native_1.CameraRoll.saveToCameraRoll(_this.props.imageUrls[_this.state.currentShowIndex || 0].URL_Imagen);
                _this.props.onSaveToCamera(_this.state.currentShowIndex);
            }
            else {
                _this.props.onSave(_this.props.imageUrls[_this.state.currentShowIndex || 0].URL_Imagen);
            }
    ...
    ImageViewer.prototype.loadImage = function (index) {
        ...
        if (!image.URL_Imagen || image.URL_Imagen.startsWith("file:")) {
            imageLoaded = true;
        }
        // 如果已知源图片宽高，直接设置为 success
        if (image.width && image.height) {
            if (this.props.enablePreload && imageLoaded === false) {
                react_native_1.Image.prefetch(image.URL_Imagen);
            }
        ...
        react_native_1.Image.getSize(image.URL_Imagen, function (width, height) {
            ...
            switch (imageInfo.status) {
              ...
              <react_native_1.View style={_this.styles.loadingContainer}>{_this.props.loadingRender()}</react_native_1.View>
                ...
                case 'success':
                    ...
                    if (typeof image.props.source === 'number') {
                        ...
                        image.props.source = __assign({ uri: image.URL_Imagen }, image.props.source);
                    }
              ...
              {_this.props.failImageSource &&
                        _this.props.renderImage({
                            source: {
                                uri: _this.props.failImageSource.URL_Imagen
                            },
                            style: {
