...
import {TouchableOpacity,Modal,Image,StatusBar,ScrollView,Animated,Dimensions,StyleSheet} from 'react-native';
...
class Fullimgcomponent extends Component {
  ...
  itemWidth = (FIXED_BAR_WIDTH / 1) - ((1 - 1) * BAR_SPACE)
  ...
  closemodal = () => {
    ...
    this.props.imagenes.forEach((image, i) => {
      const thisImage = (
        <Image
          key={`image${i}`}
      ...
      >
		    ...
		    <TouchableOpacity onPress={() => {this.closemodal()}} style={globals.cont_full_ico}>
...
export default withNavigation(Fullimgcomponent)