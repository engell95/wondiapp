          ...
          <View>
            ...
            <View style={globals.content}>
              ...
              <View style={globals.space}>
                <Text numberOfLines={1} style={globals.title4}>Descripción</Text>
                <Text style={globals.text}>{this.props.data.descripcion}</Text>
              </View>
              <View style={globals.separador}></View>
              <View style={globals.space}>
              {this.props.data.sucursales
                ?<Text numberOfLines={1} style={globals.title4}>{I18n.t('global.suc')}</Text>
                :null
              }
                <FlatList
                  numColumns={1}
                  renderItem={({item}) => this._renderItem(item)}
                  data={this.props.data.sucursales}
