        ...
        ActionSheet.show(
          {
            options:[
              ...
              { text: <Text style={globals.title3}>{I18n.t('budget.newbudget')}</Text>, icon: "add",iconColor:globals.title3.color},
              { text: <Text style={globals.title3}>{I18n.t('budget.addbudget')}</Text>, icon: "open",iconColor:globals.title3.color},
              { text: <Text style={globals.title3}>{I18n.t('global.cancel')}</Text>, icon: "close",iconColor:globals.title3.color}
            ],
          },
    ...
    ActionSheet.show(
      {
        ...
        title: <Text onPress={()=>{ActionSheet.hide();}} style={globals.title}>{I18n.t('budget.title')}</Text>      
      },
      buttonIndex => {}
    )
    this.setState({cargando:false}); 
	...
	render() {
      ...
      <Container>
        ...
        <Content>
         ...
         <ModalBugetNew open={this.state.add} user={this.props.data.user} code={this.props.code} prod={1886} suc={399} cant={this.state.cantidad} tipo={1} close={this.closemodalnew.bind(this)} close2={this.closemodalnew2.bind(this)}/>
        </Content>
      </Container>
		)
	}
