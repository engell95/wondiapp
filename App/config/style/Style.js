...
const style = StyleSheet.create({
  ...
  backgroundGradient: {position: 'absolute',top: 0,bottom: 0,right: 0,left: 0,zIndex: 0,},
    ...
    search3:{width:width * 0.8,borderRadius: 20,borderColor: '#DFDFDF'},
    ...
    //Screen
      ...
      //categoryscreen
        ...
        content_prod4:{width:'100%',height: height / 6},
        content_img4:{width:'100%',height: height / 6,borderRadius: 15}, 
      //shopscreen 
        prod_text2_c:{backgroundColor: theme.COLORS.GREY3,width: 'auto',height:height * 0.03,borderBottomLeftRadius: 10,borderBottomRightRadius: 10},
        prod_text2:{fontFamily: "SF-UI-Text-Lights",fontWeight:'normal',fontStyle:'normal',marginLeft:5,marginRight:5},
        content_push5:{width:'100%',borderRadius: 15,width:'100%',height:height / 5,backgroundColor:theme.COLORS.GREY3,flex: 1, flexDirection: 'row', flexWrap: 'wrap',marginVertical: 10,marginHorizontal: 5},
      ...
      //budgetdetscreen 
        cardbugdet2:{shadowColor: "#000",shadowOffset: {width: 0,height: 3,},shadowOpacity: 0.29,shadowRadius: 4.65,elevation: 9,marginRight:10,marginLeft:10,zIndex: 1 ,flexDirection: 'row', flex:1, borderRadius:10,backgroundColor:'white',height:height / 7},
